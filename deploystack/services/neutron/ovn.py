...
def create_ovn_networks(config, env):
    ...
    if provider_networks:
        ...
        if not create_custom_networks(networks_list=networks_list, provider_networks=provider_networks, public_bridge=public_bridge, internal_flat_bridge="", env=env) :
            return False
